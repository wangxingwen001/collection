...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier collectionType:(XFTCollectionType)myType
{
    ...
    if (self) {
        ...
        [self.contentView addSubview:self.collectedTimeLabel];
...
- (void)createPictureCell
{
    ...
    [self.contentView addSubview:self.photoTextLabel];
}
...
- (void)createVideoCell
{
    ...
    [self.contentView addSubview:self.videoImageView1];
...
- (void)createLocationCell
{
    ...
    [self.contentView addSubview:self.mapDetailLabel];
