...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.photoTextLabel = [[XFTCustomLabel alloc] initWithFrame:CGRectMake(55, 100,255, 20) TextFont:14 textColor:GRAY_COLOR textAliment:NSTextAlignmentLeft text:@"图片包含:团结湖 下午 上班" backGroundColor:[UIColor clearColor]];
